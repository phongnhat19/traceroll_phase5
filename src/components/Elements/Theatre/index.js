...
import {Stage, Layer} from 'react-konva-traceroll';
import {TRText, TRImage, TRLine, TRLineBrush, TRVideo, TRLineGroup, TRInteractive} from './../';
		...
		return(
			<div className={obj.elementId+" wrapper-element-right col-lg-4"}>
		        <div className="col-lg-12 userInfo align-content">
		        	<p className="user-name">{obj.createdUser.username}</p>
		        </div>
				<TRInteractive
					caption={obj.caption}
					comment={obj.comment}
			...
			<div id='theater_mode_div' style={{display:'flex'}}>
				<div id='theatre_container'>
					<div className='pull-top-right'>
						<a href="#" onClick={this.props.toggleTheatreMode}>
						...
						<div id='carousel_inner' className="carousel-inner">
							{
								...
								const active = currentElement === el._key ? ' active' : (i === 0 && currentElement.length === 0) ? ' active' : '',
									obj = {
										...
										caption: el.caption,
										comment: el.comment ? el.comment : new Array(),
										elementId: el.id,
								...
								if(el.type == "text"){
									return(
										<div className={el.id +" wrapper-element row item slide text-slide" + active}>
									...
									return (
						                <div className={"wrapper-element row item slide image-slide" + active}>
									...
									if (rect) {
										...
										return (
											<div className={"wrapper-element row item slide group" + active}>
												<div
													className="col-lg-8"
                                                    style={{padding: 0}}
													id={containerId}
