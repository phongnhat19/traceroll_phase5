...
class TRMenu extends Component {
    ...
    render() {
        ...
        const buttons = [
            ...
            colors = [
              {color: '#000', x: centerpos  + 20, y: 60},
              {color: '#137EFC', x: centerpos   + 20 + pading*1, y: 60},
              {color: '#52D868', x: centerpos  + 20 + pading*2, y: 60},
              {color: '#FDD02F', x: centerpos + 20 + pading*3, y: 60},
              {color: '#FC3043', x: centerpos    + 20 + pading*4 , y: 60},
            ];
        return (
