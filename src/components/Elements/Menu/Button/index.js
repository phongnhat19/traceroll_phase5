...
import {Image, Line, Group} from 'react-konva-traceroll';
...
class MenuButton extends Component {
    ...
    componentDidMount() {
        ...
        if(this.props.mode == "brush"){            
            var headpoint = [7, 5, 7, 11, 17, 11, 17, 0, 7, 5];
            this.setState({
                headpoint : headpoint
            })            
        } else if(this.props.mode == "pen"){
            var headpoint = [11, 0, 7, 11, 17, 11, 13,0];
            this.setState({
                headpoint : headpoint
            })
        }
        else if(this.props.mode == "pencil"){
            var headpoint = [11, 0, 7, 14, 17, 14, 13,0];
            this.setState({
                headpoint : headpoint
            })
        }
