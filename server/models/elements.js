...
(function(Elements){
	 ...
	 */
	Elements.getAllElements = function (offset, pageSize, callback) {

		//Get list element in order
		db.getSortedSetRevRangeByScore('elements:created-date', 
										offset*pageSize, 
										pageSize, 
										'+inf',0,
										function (err, elementIds) {
			//Get element object array
